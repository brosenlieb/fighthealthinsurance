...
4. **Hosted generative models (Azure, Anthropic, Groq, …)**: Set the relevant
...
Due to how the hook is invoked, some checks may not occur until you load the webpage
in your browser, or until they are ran manually (see below).
